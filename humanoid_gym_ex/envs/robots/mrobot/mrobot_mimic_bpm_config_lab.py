...
class MrobotMimicBPMLabCfg(MrobotMimicCommonLabCfg):
    """IsaacLab / IsaacSim entry point for the BPM/music mimic task."""
    ...
    class safety(MrobotMimicCommonLabCfg.safety):
        torque_limit = 1
    ...
    class rewards(MrobotMimicCommonLabCfg.rewards):
        ...
        class scales(MrobotMimicCommonLabCfg.rewards.scales):
