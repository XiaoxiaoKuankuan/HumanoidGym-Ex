"""IsaacGym config for MRobot specified-trajectory dance mimic.
...
class MrobotMimicDanceGymCfg(MrobotMimicCommonCfg):
...
class MrobotMimicDanceGymCfgPPO(MrobotMimicCommonCfgPPO):
    seed = 5
